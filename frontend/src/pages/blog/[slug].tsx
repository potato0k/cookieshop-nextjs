  ...
  return (
    <>
      ...
      <div className='max-w-screen-xl text-white text-center mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-20'>
        <h3 className='font-bold text-3xl mb-10 md:text-5xl'>More Reads</h3>
        <p className=''>
...
export const getStaticProps = async (context: any) => {
  ...
  const query = `*[_type == "blog" && slug.current == $slug] [0] {_id, title, description,date, image {url}, author -> {
    name, image
  }, isFeatured, slug {current}}`
...
const classNames = {
  hero: "relative pt-20 pb-2 md:pt-20 bg-[url('/image/trending.png')]",
  heroOverlay:
  ...
  blogContentWrapper:
    'flex flex-col justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:flex-row lg:px-8',
